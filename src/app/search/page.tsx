  ...
  return (
    <>
      ...
      <section className="bg-primary-800 text-white py-8 md:py-10">
        <div className="container mx-auto px-4">
          <h1 className="text-2xl md:text-3xl font-heading font-medium">
            {query
              ? <>Search results for &ldquo;{query}&rdquo;</>
              : "Search Home Services"}
            {cityFilter && (
              <span className="text-white/80"> in {cityFilter}</span>
            )}
          </h1>
                    ...
                    {cities.slice(0, 15).map((city) => (
                      <li key={city.id}>
                        <Link
                          ...
                          className={`text-sm py-1.5 px-2 block rounded-card transition-all duration-200 ease-advia ${
                  ...
                  {[4, 3, 2].map((r) => (
                    <li key={r}>
                      <Link
                        ...
                        className={`flex items-center gap-2 text-sm py-1.5 px-2 rounded-card transition-all duration-200 ease-advia ${
