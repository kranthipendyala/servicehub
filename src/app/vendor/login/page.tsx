  ...
  return (
    <div className="min-h-screen flex bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900">
      ...
      <div className="hidden lg:flex lg:w-1/2 xl:w-[55%] flex-col justify-center items-center relative overflow-hidden">
        ...
        <div className="absolute bottom-20 right-20 w-96 h-96 bg-primary-500/8 rounded-full blur-3xl" />
        ...
        <div className="relative z-10 flex flex-col items-center max-w-md px-8">
          ...
          <div className="relative w-64 h-64 mb-10">
            {/* Central gear */}
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-24 h-24 rounded-2xl bg-gradient-to-br from-primary-500 to-primary-700 flex items-center justify-center shadow-2xl shadow-primary-600/30 rotate-3">
            ...
            <div className="absolute bottom-2 right-4 w-14 h-14 rounded-xl bg-primary-500/20 backdrop-blur-sm border border-primary-400/20 flex items-center justify-center animate-bounce" style={{ animationDuration: "4.5s", animationDelay: "1.5s" }}>
          ...
          <h1 className="text-3xl xl:text-4xl font-extrabold text-white text-center mb-3">
            Welcome to <span className="bg-gradient-to-r from-primary-400 to-primary-300 bg-clip-text text-transparent">VendorHub</span>
          </h1>
          ...
          <div className="bg-white rounded-2xl shadow-2xl p-8">
              ...
              <>
                ...
                <div className="space-y-5">
                  ...
                  <button
                    ...
                    className="w-full py-3 px-4 bg-primary-600 text-white text-sm font-semibold rounded-xl hover:bg-primary-700 focus:ring-4 focus:ring-primary-500/30 transition-all disabled:opacity-60 disabled:cursor-not-allowed flex items-center justify-center gap-2"
                  >
                    {loading && (
            ...
            <div className="mt-6 pt-5 border-t border-gray-100">
              <Link
                ...
                className="flex items-center justify-center gap-2 w-full py-3 px-4 bg-primary-50 text-primary-700 text-sm font-semibold rounded-xl hover:bg-primary-100 transition-all group"
              >
