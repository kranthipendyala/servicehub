    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-3xl mx-auto px-4 md:px-4 py-6 space-y-5">
        ...
        {booking.status === "completed" && !reviewSubmitted && (
          <div className="bg-white rounded-2xl shadow-sm p-5">
            <h2 className="font-bold text-gray-900 mb-1">Rate Your Experience</h2>
            <p className="text-sm text-gray-500 mb-4">How was the service? Your review helps other customers.</p>
            ...
            <textarea
              ...
              className="w-full border border-gray-300 rounded-xl px-4 py-3 text-sm resize-none focus:border-emerald-500 focus:ring-2 focus:ring-emerald-500/20 mb-4"
            />
        ...
        {reviewSubmitted && (
          <div className="bg-emerald-50 border border-emerald-200 rounded-2xl p-5 text-center">
            <svg className="w-10 h-10 mx-auto text-emerald-500 mb-2" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
              <path strokeLinecap="round" strokeLinejoin="round" d="M9 12.75L11.25 15 15 9.75M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
            </svg>
            <h3 className="font-bold text-emerald-800 mb-1">Thank you for your review!</h3>
            <p className="text-sm text-emerald-600">Your feedback helps improve services for everyone.</p>
          </div>
        )}
