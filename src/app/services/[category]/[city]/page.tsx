        ...
        <div className="bg-gradient-to-r from-[#0d9488] via-[#0d9488] to-[#0d9488] text-white">
          <div className="max-w-7xl mx-auto px-4 py-12">
            <nav className="flex items-center gap-2 text-sm text-blue-200 mb-4">
              ...
              <span>/</span>
              <Link href={`/services/${category}`} className="hover:text-white transition-colors">{cat.name}</Link>
              <span>/</span>
                    ...
                    <div className="flex items-center gap-3 mt-4">
                      {biz.rating !== undefined && biz.rating > 0 && (
                        <div className="flex items-center gap-1 bg-green-50 px-2 py-1 rounded-lg">
                          <svg className="w-4 h-4 text-green-600" fill="currentColor" viewBox="0 0 20 20"><path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" /></svg>
